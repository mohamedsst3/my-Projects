...
<table class="table"> 
  ...
  <tr><td>
    ...
    <input type="text" name="header1_text" id="header1" class="form-control" placeholder="headerText">

    <br>

    <label for="header2">header2</label>
    <input type="text" name="header2_text" id="header2" class="form-control" placeholder="HeaderText2">
